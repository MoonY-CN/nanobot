...
class WriteFileTool(Tool):
    ...
    @property
    def description(self) -> str:
        return "将内容写入给定路径的文件。如果需要会创建父目录。"
...
class EditFileTool(Tool):
    ...
    @property
    def description(self) -> str:
        return "通过将 old_text 替换为 new_text 来编辑文件。old_text 必须完全存在于文件中。"
    ...
    async def execute(self, path: str, old_text: str, new_text: str, **kwargs: Any) -> str:
        try:
            ...
            if count > 1:
                return f"警告：old_text 出现了 {count} 次。请提供更多上下文以使其唯一。"
